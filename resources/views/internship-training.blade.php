...
@section('content')
    ...
    <div class="block">
        ...
        <div class="block_content">
            ...
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/gOxjWFWLF24">Смотреть</div>
        </div>
        <div class="block_content">
        ...
        <div class="block_content">
            ...
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/7prJqwWP5no">Смотреть</div>
        </div>
        <div class="block_content">
            <div class="bc_title">Тикетс ЖД:</div>
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/p39z64W3HmQ">Смотреть</div>
        </div>
        <div class="block_content">
            <div class="bc_title">Трансавиа:</div>
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/CjFO_vNmH_c">Смотреть</div>
        </div>
    </div>
    <div class="block">
    ...
    <div class="block">
        ...
        <div class="block_content">
            ...
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/8JO3Yy9KfzU">Смотреть</div>
        </div>

        <div class="block_content">
            <div class="bc_title">День 2: Технология продажи туров. Часть 2</div>
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/E53mtA_oi_Y">Смотреть</div>
        </div>

        <div class="block_content">
            <div class="bc_title">День 3: Работа с возражениями туристов</div>
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/LXbhNeadY3Y">Смотреть</div>
        </div>

        <div class="block_content">
            <div class="bc_title">День 4: Инструменты эффективного продавца</div>
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/ppozAj5QF9g">Смотреть</div>
        </div>

        <div class="block_content">
            <div class="bc_title">День 5: Как доводить каждую сделку до результата</div>
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/Mbta-LdnyE0">Смотреть</div>
        </div>
    </div>
    <div class="block">
        ...
        <div class="block_content">
            ...
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/MF5QG0TAGM0">Смотреть</div>
        </div>
        <div class="block_content">
            <div class="bc_title">создание заявки и обращения в ЮОНЕ ДЖОКСИ:</div>
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/0IIwDuwtGYk">Смотреть</div>
        </div>
        <div class="block_content">
            <div class="bc_title">Вебинар для новичков</div>
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/An9oGdJOAcY">Смотреть</div>
        </div>
        <div class="block_content">
            <div class="bc_title">Создание заявки</div>
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/fyqJTbSTH2w">Смотреть</div>
        </div>
        <div class="block_content">
            <div class="bc_title">Создание обращения</div>
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/nmn4ANzkEr8">Смотреть</div>
        </div>
        <div class="block_content">
            <div class="bc_title">Создание туриста</div>
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/9uhKPgb0s6I">Смотреть</div>
        </div>
        <div class="block_content">
            <div class="bc_title">Видео #5:</div>
            <div class="b_download_btn" onclick="return page.showVideoYoutube(this)" data-video="https://www.youtube.com/embed/nO81fyQBTZw">Смотреть</div>
        </div>
    </div>
    <div class="block">
